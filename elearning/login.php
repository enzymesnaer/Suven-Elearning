...
// bypass login if valid user session exists
if(isset($_COOKIE['userloggedin']) && (!is_anonymous())){
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary submitBtn" onclick="validateCookie()">ValidateCookie</button>
