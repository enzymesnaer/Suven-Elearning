                      ...
                      <a href="https://docs.google.com/forms/d/e/1FAIpQLScPpX9SPBQkjj5xklDta_EOO0mADa-st3Zw8941ThkS5woKCQ/viewform" target="_blank">
                        <li class="list-group-item style_prevu_kit smcontent">
                          <div class="row">
                            ...
                            <a href="./mlb" target="_blank" style="left:501px;bottom:5px;" type="button" id="btnadd2" class="label label-primary  exploregreen">Explore</a>
                          </div>
                        </li>
                      </a>
                      <a href="https://docs.google.com/forms/d/e/1FAIpQLScPpX9SPBQkjj5xklDta_EOO0mADa-st3Zw8941ThkS5woKCQ/viewform" target="_blank">
                        <li class="list-group-item style_prevu_kit smcontent">
                          <div class="row">
                            ...
                            <a href="./mli" target="_blank" style="left:501px;bottom:3px;" type="button" id="btnadd2" class="label label-primary  exploregreen">Explore</a>
                          </div>
                        </li>
                      </a>
                      <a href="https://docs.google.com/forms/d/e/1FAIpQLScPpX9SPBQkjj5xklDta_EOO0mADa-st3Zw8941ThkS5woKCQ/viewform" target="_blank">
    ...
    <div class="container-fluid fluidmargin" style="margin: 0 5% 0 9%; z-index:500;">
      ...
      <div class="row gridrow" style="margin:auto;">
        ...
        <div class="col-lg-3 col-md-3  card style_prevu_kit2 gridcard" style="margin:20px;border: 0.5px solid gainsboro;background-color:white;max-height: 260px;">
          ...
          <a href="./mlb" target="_blank" style="left:501px;bottom:5px;" type="button" id="btnadd2" class="hidden-lg hidden-md label label-primary  exploregreen">Explore</a>
          <a href="./mlb" target="_blank" style="left:140px;bottom:-51px;" type="button" id="btnadd2" class="label label-primary hidden-xs hidden-sm exploregreen">Explore</a>
        </div>
      </div>
      <div class="row gridrow" style="margin:auto;">
        <div class="col-lg-3 col-md-3 card style_prevu_kit2 gridcard" style="margin:20px;border: 0.5px solid gainsboro;background-color:white;max-height: 260px;">
          ...
          <a href="./mli" target="_blank" style="left:501px;bottom:5px;" type="button" id="btnadd2" class="hidden-lg hidden-md label label-primary  exploregreen">Explore</a>
          <a href="./mli" target="_blank" style="left:140px;bottom:-51px;" type="button" id="btnadd2" class="label label-primary hidden-xs hidden-sm exploregreen">Explore</a>
        </div>
        <div class="col-lg-3 col-md-3  card style_prevu_kit2 gridcard" style="margin:20px;border: 0.5px solid gainsboro;background-color:white;max-height: 260px;">
          <div class="">
            <a href="https://docs.google.com/forms/u/1/d/e/1FAIpQLScPpX9SPBQkjj5xklDta_EOO0mADa-st3Zw8941ThkS5woKCQ/viewform" target="_blank">
